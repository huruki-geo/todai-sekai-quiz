...
2.  **設問 (Questions):**
    *   リード文のテーマから派生した複数の独立した小問のリスト（配列形式）。設問数は必ず10問にしてください。
    *   各小問は、特定の**固有名詞（人名、地名、事件名、制度名、会議名、条約名、著作名、宗教名、組織名など）**を答えさせる形式にしてください。
    *   人名や地名、事件名、法名などのジャンルは、ばらけさせてください。
    *   設問は、リード文のテーマから連想される、**様々な時代・地域にわたる**内容を含めてください。時代や地域が偏らないように注意してください。**テーマとの整合性よりも、時代や地域の偏りが少ない方が完全に重要です。**
    *   中国史や遊牧民族史、文化史の問題は必ず含めてください。
    *   同じような問題が連続しないようにしてください。
    *   中学レベルの内容(民族自決、アヘン戦争、ハンムラビ法典など)の出題は一問または二問にとどめてください。
3.  **解答 (Answers):**
...
【難易度と質】
*   内容はアカデミックで、東京大学の入試レベルにふさわしい難易度と質を保ってください。
